          ...
          {client && (
            <div style={{ background: 'white', padding: '20px', borderRadius: '10px', marginTop: '20px', boxShadow: '0 2px 5px rgba(0,0,0,0.1)', borderTop: '4px solid #28a745' }}>
              ...
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px', fontSize: '14px' }}>
                <div><strong>প্যাকেজ:</strong> {client.package}</div>
              ...
              </div>              <button onClick={() => window.print()} style={{ marginTop: '15px', width: '100%', padding: '10px', background: '#6c757d', color: 'white', border: 'none', borderRadius: '5px', cursor: 'pointer' }}>🖨️ প্রিন্ট করুন</button>
            </div>
          )}
        </div>
      )}
